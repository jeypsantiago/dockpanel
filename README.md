...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~19MB of RAM</strong>. 776 API endpoints. 152 app templates. 432 E2E tests. ~41MB binaries. Zero subscriptions.
</p>
