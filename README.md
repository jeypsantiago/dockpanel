...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~19MB of RAM</strong>. 760 API endpoints. 152 app templates. 426 E2E tests. ~41MB binaries. Zero subscriptions.
</p>
